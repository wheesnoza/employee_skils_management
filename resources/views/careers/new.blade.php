                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('career.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <input id="start_year" name="start_year" type="number" class="form-control col-md-8 @error('start_year') is-invalid @enderror" placeholder="2018" value="{{ old('start_year') }}">
                                    @error('start_year')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-3">
                                    <input id="end_year" name="end_year" type="number" class="form-control col-md-8 @error('end_year') is-invalid @enderror" placeholder="2019" value="{{ old('end_year') }}">
                                    @error('end_year')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
